      ...
      for (; _sync_for_iterator.moveNext(); ) {
        {
          ...
          {
            if ((merged.length === 0 || (!(merged[merged.length - 1].allowsAny(constraint)) && !(areAdjacent(merged[merged.length - 1], constraint))))) {
              {
                (merged.push(constraint), null);
              }
            } else {
              {
                merged[(merged.length - 1)] = __dartAs(merged[merged.length - 1].union(constraint), value => value instanceof VersionRange, "VersionRange");
              }
            }
          }
        }
...
const _equality = __dartConst("[\"instance\",\"class:IterableEquality\",[\"typeArgument\",\"InterfaceType(Object)\"],[\"field\",\"field:IterableEquality._elementEquality\",[\"instance\",\"class:DefaultEquality\",[\"typeArgument\",\"NeverType(Never)\"]]]]", () => Object.freeze(Object.assign(Object.create(IterableEquality.prototype), { _elementEquality: __dartConst("[\"instance\",\"class:DefaultEquality\",[\"typeArgument\",\"NeverType(Never)\"]]", () => Object.freeze(Object.create(DefaultEquality.prototype))) })));
