...
import 'sdk_async_invocations.dart';
import 'sdk_collection_instances.dart';
...
final class _EsmEmitter {
  ...
  String _emitConstructorInvocation(k.ConstructorInvocation expression) {
    ...
    final sdkConstructor = DartSdkConstructorInvocationEmitter(
  ...
  String _emitStaticInvocation(k.StaticInvocation expression) {
    final positionalArgs = expression.arguments.positional
        ...
        .toList();
    final args = _emitArguments(expression.arguments);
    final asyncInvocation = DartSdkAsyncInvocationEmitter(
      helpers: _usedHelpers,
      namedArgument: _namedArgument,
      emitTypeTest: _emitTypeTest,
    ...
    final webInvocation = DartSdkWebInvocationEmitter(
      helpers: _usedHelpers,
      namedArgument: _namedArgument,
    ...
    final jsInteropInvocation = DartSdkJsInteropInvocationEmitter(
      helpers: _usedHelpers,
      emitTypeTest: _emitTypeTest,
    ).emitStaticInvocation(expression, positionalArgs);
  ...
  String _emitInstanceInvocation(k.InstanceInvocation expression) {
    ...
    final collectionInvocation =
        DartSdkCollectionInstanceEmitter(
          ...
          hasOnlyNamedArguments: _hasOnlyNamedArguments,
          namedArgument: _namedArgument,
          emitMaybeFixedList: _emitMaybeFixedList,
          emitTypeTest: _emitTypeTest,
        ).emitInvocation(
          target,
          name,
          ...
          expression.arguments,
          expression,
          receiverCollectionKind: receiverCollectionKind,
        );
  ...
  String _emitInstanceGet(k.InstanceGet expression) {
    ...
    final jsInteropGet = DartSdkJsInteropInvocationEmitter(
      helpers: _usedHelpers,
      emitTypeTest: _emitTypeTest,
    ).emitInstanceGet(expression.interfaceTargetReference, name, receiver);
    ...
    final asyncGet = DartSdkAsyncInvocationEmitter(
      helpers: _usedHelpers,
      namedArgument: _namedArgument,
      emitTypeTest: _emitTypeTest,
    ...
    final webGet = DartSdkWebInvocationEmitter(
      helpers: _usedHelpers,
      namedArgument: _namedArgument,
      hasOnlyNamedArguments: _hasOnlyNamedArguments,
    ).emitGet(expression.interfaceTargetReference, name, receiver);
  ...
  String _emitInstanceSet(k.InstanceSet expression) {
    ...
    final webSet = DartSdkWebInvocationEmitter(
      helpers: _usedHelpers,
      namedArgument: _namedArgument,
      hasOnlyNamedArguments: _hasOnlyNamedArguments,
    ).emitSet(expression.interfaceTargetReference, name, receiver, value);
    if (webSet != null) {
      return webSet;
    }
  ...
  String _emitNullAwareInstancePropertyName(k.Reference target, String name) {
    return DartSdkWebInvocationEmitter(
          ...
          namedArgument: _namedArgument,
          hasOnlyNamedArguments: _hasOnlyNamedArguments,
        ).nullAwareInstancePropertyName(target, name) ??
        _memberName(name);
  }
