...
final class KernelToEsmIrLoweringStage
  ...
  EsmExpressionIr? _lowerSdkStaticTearOffConstant(
    ...
    final mathSymbol = dartMathStaticInvocationSymbol(reference);
    final mathMethod = mathSymbol == null
        ? null
        : _jsMathStaticFunctionName(mathSymbol);
  ...
  EsmExpressionIr? _lowerRuntimeStaticInvocation(
    ...
    final coreRegExpStatic = _lowerCoreRegExpStaticInvocation(
      world,
      helpers,
      locals,
      expression,
    ...
    switch (dartSdkStaticInvocationSymbol(expression.targetReference)) {
      ...
      case DartSdkStaticInvocationSymbol.iterableElementErrorNoElement
          when positional.isEmpty &&
              expression.arguments.named.isEmpty &&
              expression.arguments.types.isEmpty:
        return _lowerCoreErrorLiteral(helpers, 'StateError', 'No element');
  ...
  EsmExpressionIr _lowerCoreErrorLiteral(
    ...
    return EsmCallIr(
      callee: helpers.reference(runtimeHelpers, EsmRuntimeHelper.coreError),
      arguments: [EsmStringLiteralIr(typeName), EsmStringLiteralIr(message)],
    );
  }
  ...
  EsmExpressionIr? _lowerCoreRegExpStaticInvocation(
    EsmSemanticWorld world,
    EsmRuntimeHelperUseSet helpers,
    Map<k.VariableDeclaration, String> locals,
    k.StaticInvocation expression, {
  ...
  EsmExpressionIr? _lowerCoreErrorStaticInvocation(
    ...
    final target = kernelReferencePath(expression.targetReference);
    final argumentCheck = _lowerArgumentErrorStaticInvocation(
      world,
      helpers,
      locals,
      expression,
    ...
    final rangeCheck = _lowerRangeErrorStaticInvocation(
      world,
      helpers,
      locals,
      expression,
  ...
  EsmExpressionIr? _lowerArgumentErrorStaticInvocation(
    EsmSemanticWorld world,
    EsmRuntimeHelperUseSet helpers,
    Map<k.VariableDeclaration, String> locals,
    k.StaticInvocation expression,
  ...
  EsmExpressionIr? _lowerRangeErrorStaticInvocation(
    EsmSemanticWorld world,
    EsmRuntimeHelperUseSet helpers,
    Map<k.VariableDeclaration, String> locals,
    k.StaticInvocation expression,
