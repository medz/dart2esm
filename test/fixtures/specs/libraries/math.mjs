...
export function main() {
  ...
  const constPoint = __dartConst("[\"InstanceConstant\",\"InstanceConstant(const Point<int>{Point.x: 2, Point.y: 5})\"]", () => __dartPoint(2, 5));
  __dartPrint(`point ${__dartStr(point.x)}:${__dartStr(point.y)} ${__dartStr(Number(point.magnitude).toFixed(1))} ${__dartStr(Number(point.distanceTo(otherPoint)).toFixed(2))} ${__dartStr(point.squaredDistanceTo(otherPoint))} ${__dartStr(moved.x)}:${__dartStr(moved.y)} ${__dartStr(delta.x)}:${__dartStr(delta.y)} ${__dartStr(scaled.x)}:${__dartStr(scaled.y)} ${__dartStr(__dartEquals(point, __dartPoint(3, 4)))} ${__dartStr(((hide(point) != null && typeof hide(point) === "object") && hide(point).__dartType === "Point"))} ${__dartStr(__dartConst("[\"InstanceConstant\",\"InstanceConstant(const Point<int>{Point.x: 2, Point.y: 5})\"]", () => __dartPoint(2, 5)).x + __dartConst("[\"InstanceConstant\",\"InstanceConstant(const Point<int>{Point.x: 2, Point.y: 5})\"]", () => __dartPoint(2, 5)).y)}`);
  ...
  const constRectangle = __dartConst("[\"InstanceConstant\",\"InstanceConstant(const Rectangle<int>{Rectangle.left: 0, Rectangle.top: 1, Rectangle.width: 2, Rectangle.height: 3})\"]", () => __dartRectangle(0, 1, 2, 3));
  __dartPrint(`rect ${__dartStr(rectangle.left)}:${__dartStr(rectangle.top)}:${__dartStr(rectangle.right)}:${__dartStr(rectangle.bottom)} ${__dartStr(rectangle.topLeft.x)}:${__dartStr(rectangle.bottomRight.y)} ${__dartStr(rectangle.containsPoint(__dartPoint(2, 3)))} ${__dartStr(rectangle.containsRectangle(__dartRectangle(1, 2, 1, 1)))} ${__dartStr(rectangle.intersects(otherRectangle))} ${__dartStr(intersection.left)}:${__dartStr(intersection.top)}:${__dartStr(intersection.width)}:${__dartStr(intersection.height)} ${__dartStr(bounds.left)}:${__dartStr(bounds.top)}:${__dartStr(bounds.width)}:${__dartStr(bounds.height)} ${__dartStr(fromPoints.left)}:${__dartStr(fromPoints.top)}:${__dartStr(fromPoints.width)}:${__dartStr(fromPoints.height)} ${__dartStr(__dartEquals(rectangle, __dartRectangle(1, 2, 3, 4)))} ${__dartStr(((hide(rectangle) != null && typeof hide(rectangle) === "object") && hide(rectangle).__dartType === "Rectangle"))} ${__dartStr(__dartConst("[\"InstanceConstant\",\"InstanceConstant(const Rectangle<int>{Rectangle.left: 0, Rectangle.top: 1, Rectangle.width: 2, Rectangle.height: 3})\"]", () => __dartRectangle(0, 1, 2, 3)).bottom)}`);
}
