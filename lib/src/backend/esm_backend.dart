...
final class _EsmEmitter {
  ...
  EsmBackendResult emit() {
    ...
    _prepareClassRuntime(module.classRuntime);
  ...
  void _prepareClassRuntime(EsmClassRuntimePlan runtime) {
    ...
    for (final klass in sortedClasses) {
      final superclass = runtime.jsInterfaceSuperclassFor(klass);
      if (superclass != null) {
    ...
    _jsInterfaceBaseClasses.addAll(runtime.interfaceBaseClasses);
  }
