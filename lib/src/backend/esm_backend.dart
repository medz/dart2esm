...
final class _EsmEmitter {
  ...
  final _names = JsNameAllocator(generatedGlobalNames: esmRuntimeGlobalNames);
  ...
  EsmBackendResult emit() {
    ...
    writeln();
    _emitLibraryTypes(libraries, plan, roots.exportNamesByLibrary);
    for (final library in libraries) {
      _emitLibraryMembers(
        library,
        plan,
        exportNames: roots.exportNamesFor(library),
      );
    }
