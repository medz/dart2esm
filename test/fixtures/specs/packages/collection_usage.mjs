...
class CanonicalizedMap {
  ...
  addAll(other) {
    (other.forEach((value, key) => (function(key, value) { return (() => { let v = key; return (() => { let v_1 = value; return (() => { let v_2 = this["[]="](v, v_1); return v_1; })(); })(); })(); })(key, value)), null);
  }
  addEntries(entries) {
    return __dartMapAddEntries(this._base, Array.from(entries, function(e) { return Object.freeze({ key: (() => { let v = e.key; return (this._canonicalize)(v); })(), value: Object.freeze({ key: e.key, value: e.value }) }); }));
  }
  cast() {
...
class _IteratorZip {
  ...
  moveNext() {
    ...
    this._current = __dartFixedList(Array.from({ length: this._iterators.length }, (_, index) => (function(i) { return this._iterators[i].current; })(index)));
    return true;
  }
  get current() {
