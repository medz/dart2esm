...
EsmExpression? _lowerDartCoreDoubleStaticInvocation({
  ...
  final callee = switch (target) {
    ...
    'dart:core::double::@methods::tryParse' => const EsmIdentifier(
      '__dartDoubleTryParse',
    ),
    'dart:core::num::@methods::parse' => const EsmIdentifier('__dartNumParse'),
    'dart:core::num::@methods::tryParse' => const EsmIdentifier(
      '__dartNumTryParse',
    ),
    _ => null,
  };
  ...
  return EsmCall(callee: callee, arguments: [lower(positional.single)]);
}

EsmExpression? _lowerDartCoreBigIntStaticInvocation({
  required k.StaticInvocation expression,
  required String target,
  required EsmRuntimeHelperUseSet helpers,
  required EsmRuntimeHelperRegistry runtimeHelpers,
  ...
  return EsmCall(
    ...
    arguments: [
      ...
      if (radix == null) const EsmNullLiteral() else lower(radix),
      EsmBooleanLiteral(tryParse),
    ],
  );
}
